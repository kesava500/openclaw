...
export const ar: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      useCurrentChat: "استخدام الدردشة الحالية",
      useCurrentChatAria: "استخدام الدردشة الحالية لطلبات المراجعة",
      useCurrentChatTooltip:
        "إرسال طلبات المراجعة إلى جلسة الدردشة الحالية بدلًا من جلسة ورشة عمل المقترح.",
    },
  },
  activity: {
    title: "النشاط",
  ...
  workboard: {
    ...
    detailNotePlaceholder: "أضف ملاحظة قرار أو عائق أو إثبات...",
    ...
    dependenciesReadyTitle: "اكتملت {count} من التبعيات.",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      empty: "لم يتم لمس أي ملفات في هذه الجلسة بعد",
      changed: "تم التغيير",
      read: "مقروء",
      artifacts: "العناصر الناتجة",
      ...
      truncated: "يتم عرض أول الملفات المطابقة. حسّن البحث لتضييق النتائج.",
      session: "الجلسة",
      missing: "مفقود",
      summary: "ملخص مساحة عمل الجلسة",
      changedCount: "تم تغيير {count}",
      readCount: "تمت قراءة {count}",
      artifactCount: "{count} عناصر ناتجة",
      browserCount: "يتم عرض {count}",
