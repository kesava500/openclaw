...
export const de: TranslationMap = {
  ...
  workboard: {
    ...
    detailNoNotes: "Noch keine Bedienerhinweise.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Sitzungs-Workspace",
      expand: "Sitzungs-Workspace erweitern",
      collapse: "Sitzungs-Workspace reduzieren",
      workspace: "Sitzung",
      files: "Workspace",
      refresh: "Sitzungs-Workspace aktualisieren",
      loading: "Sitzungs-Workspace wird geladen…",
      ...
      truncated:
        "Die ersten passenden Dateien werden angezeigt. Verfeinern Sie die Suche, um die Ergebnisse einzugrenzen.",
      session: "Sitzung",
      missing: "Fehlt",
      ...
      actions: "Aktionen für Workspace-Dateien",
      preview: "Vorschau",
