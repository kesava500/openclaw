...
export const es: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Enviar solicitudes de revisión a la sesión de chat actual en lugar de a la sesión del taller de la propuesta.",
    },
  },
  activity: {
    title: "Actividad",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      empty: "Aún no se han modificado archivos en esta sesión",
      changed: "Modificado",
      read: "Leídos",
      ...
      truncated:
        "Se muestran los primeros archivos coincidentes. Refina la búsqueda para reducir los resultados.",
      session: "Sesión",
      missing: "Faltante",
