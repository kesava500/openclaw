...
export const fa: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      useCurrentChat: "استفاده از گفت‌وگوی فعلی",
      useCurrentChatAria: "استفاده از گفت‌وگوی فعلی برای درخواست‌های بازبینی",
      useCurrentChatTooltip:
        "درخواست‌های بازبینی را به‌جای جلسه کارگاه پیشنهاد، به جلسه گفت‌وگوی فعلی ارسال کنید.",
    },
  },
  activity: {
    title: "فعالیت",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "فضای کاری جلسه",
      expand: "گسترش فضای کاری جلسه",
      collapse: "جمع کردن فضای کاری جلسه",
      workspace: "جلسه",
      files: "فضای کاری",
      refresh: "بازآوری فضای کاری جلسه",
      loading: "در حال بارگذاری فضای کاری جلسه…",
      empty: "هنوز هیچ فایلی در این جلسه تغییر نکرده است",
      changed: "تغییر کرده",
      read: "خواندن",
      artifacts: "Artifacts",
      ...
      noSearchResults: "هیچ فایل مطابقی یافت نشد.",
      truncated:
        "اولین فایل‌های مطابق نمایش داده می‌شوند. برای محدود کردن نتایج، جستجو را دقیق‌تر کنید.",
      session: "نشست",
      missing: "موجود نیست",
      summary: "خلاصه Workspace نشست",
      changedCount: "{count} تغییر کرده",
      readCount: "{count} خوانده‌شده",
      artifactCount: "{count} Artifacts",
      browserCount: "{count} نمایش داده‌شده",
      actions: "اقدام‌های فایل Workspace",
      preview: "پیش‌نمایش",
      copyPath: "کپی مسیر",
    },
  },
