...
export const fr: TranslationMap = {
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Espace de travail de la session",
      expand: "Développer l’espace de travail de la session",
      collapse: "Réduire l’espace de travail de la session",
      workspace: "Session",
      files: "Espace de travail",
      refresh: "Actualiser l’espace de travail de la session",
      loading: "Chargement de l’espace de travail de la session…",
      ...
      truncated:
        "Affichage des premiers fichiers correspondants. Affinez la recherche pour limiter les résultats.",
      session: "Session",
      missing: "Manquant",
