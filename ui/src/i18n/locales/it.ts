...
export const it: TranslationMap = {
  ...
  workboard: {
    ...
    detailNoNotes: "Nessuna nota dell'operatore per ora.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Spazio di lavoro della sessione",
      expand: "Espandi spazio di lavoro della sessione",
      collapse: "Comprimi spazio di lavoro della sessione",
      workspace: "Sessione",
      files: "Spazio di lavoro",
      refresh: "Aggiorna spazio di lavoro della sessione",
      loading: "Caricamento dello spazio di lavoro della sessione…",
      empty: "Nessun file modificato finora in questa sessione",
      changed: "Modificato",
      read: "Letti",
      artifacts: "Artefatti",
      browser: "File del progetto",
      path: "Percorso del workspace",
      root: "Radice",
      search: "Cerca file",
