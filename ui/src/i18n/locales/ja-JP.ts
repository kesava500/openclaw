...
export const ja_JP: TranslationMap = {
  ...
  workboard: {
    ...
    detailWorkerLogs: "ワーカー ログ",
    detailWorkerProtocol: "ワーカー プロトコル",
    ...
    detailOperatorNotes: "オペレーター メモ",
    detailNoNotes: "オペレーターのメモはまだありません。",
    detailNotePlaceholder: "決定事項、ブロッカー、または証跡メモを追加...",
    detailAddNote: "メモを追加",
    ...
    dependenciesBlockedTitle: "依存関係の完了待ち: {parents}。",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "セッション ワークスペース",
      expand: "セッション ワークスペースを展開",
      collapse: "セッション ワークスペースを折りたたむ",
      workspace: "セッション",
      files: "ワークスペース",
      refresh: "セッション ワークスペースを更新",
      loading: "セッション ワークスペースを読み込み中…",
      empty: "このセッションで変更されたファイルはまだありません",
      changed: "変更済み",
      read: "読み取り済み",
      artifacts: "Artifacts",
      browser: "プロジェクトファイル",
      ...
      truncated:
        "最初に一致したファイルを表示しています。結果を絞り込むには検索条件を調整してください。",
      session: "セッション",
      missing: "見つかりません",
      summary: "セッションワークスペースの概要",
      changedCount: "{count} 件変更",
      readCount: "{count} 件読み取り済み",
      artifactCount: "{count} 件の Artifacts",
