...
export const ko: TranslationMap = {
  ...
  workboard: {
    ...
    dependenciesBlockedTitle: "종속성을 기다리는 중: {parents}.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "세션 작업 영역",
      expand: "세션 작업 영역 펼치기",
      collapse: "세션 작업 영역 접기",
      workspace: "세션",
      files: "작업 영역",
      refresh: "세션 작업 영역 새로 고침",
      loading: "세션 작업 영역 로드 중…",
      empty: "아직 이 세션에서 수정된 파일이 없습니다",
      changed: "변경됨",
      read: "읽음",
      artifacts: "아티팩트",
      browser: "프로젝트 파일",
      ...
      truncated: "처음으로 일치하는 파일을 표시합니다. 결과를 좁히려면 검색을 구체화하세요.",
      session: "세션",
      missing: "누락됨",
      summary: "세션 워크스페이스 요약",
      changedCount: "{count}개 변경됨",
      readCount: "{count}개 읽음",
      artifactCount: "아티팩트 {count}개",
