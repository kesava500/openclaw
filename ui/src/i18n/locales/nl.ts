...
export const nl: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Stuur revisieverzoeken naar de huidige chatsessie in plaats van naar de workshopsessie van het voorstel.",
    },
  },
  activity: {
    title: "Activiteit",
  ...
  workboard: {
    ...
    detailOperatorNotes: "Opmerkingen van operator",
    ...
    dependenciesReadyTitle: "{count} afhankelijkheden zijn voltooid.",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      collapse: "Sessiewerkruimte samenvouwen",
      workspace: "Sessie",
      files: "Werkruimte",
      refresh: "Sessiewerkruimte vernieuwen",
      loading: "Sessiewerkruimte laden…",
      empty: "Nog geen bestanden aangeraakt in deze sessie",
      changed: "Gewijzigd",
      read: "Gelezen",
      ...
      truncated:
        "De eerste overeenkomende bestanden worden weergegeven. Verfijn de zoekopdracht om de resultaten te beperken.",
      session: "Sessie",
      missing: "Ontbreekt",
      summary: "Samenvatting van sessiewerkruimte",
      changedCount: "{count} gewijzigd",
      readCount: "{count} gelezen",
      artifactCount: "{count} artefacten",
      browserCount: "{count} weergegeven",
      actions: "Acties voor werkruimtebestanden",
      preview: "Voorbeeld",
