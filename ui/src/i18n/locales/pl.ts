...
export const pl: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "Użyj bieżącego czatu do żądań poprawek",
      useCurrentChatTooltip:
        "Wysyłaj żądania poprawek do bieżącej sesji czatu zamiast do sesji warsztatu propozycji.",
    },
  },
  activity: {
    title: "Aktywność",
  ...
  workboard: {
    ...
    dependenciesReadyTitle: "{count} zależności są ukończone.",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      empty: "W tej sesji nie zmieniono jeszcze żadnych plików",
      changed: "Zmieniono",
      read: "Odczytane",
      artifacts: "Artefakty",
      ...
      truncated:
        "Wyświetlane są pierwsze pasujące pliki. Doprecyzuj wyszukiwanie, aby zawęzić wyniki.",
      session: "Sesja",
      missing: "Brakujące",
      summary: "Podsumowanie obszaru roboczego sesji",
      changedCount: "{count} zmienione",
      readCount: "{count} odczytane",
      artifactCount: "{count} artefaktów",
      browserCount: "{count} wyświetlone",
      actions: "Działania na plikach obszaru roboczego",
      preview: "Podgląd",
