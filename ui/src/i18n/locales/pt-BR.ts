...
export const pt_BR: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "Usar chat atual para solicitações de revisão",
      useCurrentChatTooltip:
        "Enviar solicitações de revisão para a sessão de chat atual em vez da sessão de workshop da proposta.",
    },
  },
  activity: {
    title: "Atividade",
  ...
  workboard: {
    ...
    detailOperatorNotes: "Observações do operador",
    detailNoNotes: "Ainda não há notas do operador.",
    ...
    dependenciesReadyTitle: "{count} dependências foram concluídas.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Workspace da sessão",
      expand: "Expandir workspace da sessão",
      collapse: "Recolher workspace da sessão",
      workspace: "Sessão",
      files: "Workspace",
      refresh: "Atualizar workspace da sessão",
      loading: "Carregando workspace da sessão…",
      empty: "Nenhum arquivo alterado nesta sessão ainda",
      changed: "Alterado",
      read: "Lidos",
      artifacts: "Artefatos",
      ...
      truncated:
        "Mostrando os primeiros arquivos correspondentes. Refine a pesquisa para restringir os resultados.",
      session: "Sessão",
      missing: "Ausente",
      summary: "Resumo do workspace da sessão",
      changedCount: "{count} alterados",
      readCount: "{count} lidos",
      artifactCount: "{count} artefatos",
      browserCount: "{count} exibidos",
