...
export const tr: TranslationMap = {
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      empty: "Bu oturumda henüz dokunulan dosya yok",
      ...
      truncated: "İlk eşleşen dosyalar gösteriliyor. Sonuçları daraltmak için aramayı netleştirin.",
      session: "Oturum",
      missing: "Eksik",
      summary: "Oturum çalışma alanı özeti",
      changedCount: "{count} değiştirildi",
      readCount: "{count} okundu",
      artifactCount: "{count} artifakt",
      browserCount: "{count} gösteriliyor",
      actions: "Çalışma alanı dosya eylemleri",
      preview: "Önizleme",
