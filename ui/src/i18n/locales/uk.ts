...
export const uk: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip:
        "Надсилати запити на доопрацювання до поточного сеансу чату замість сеансу workshop пропозиції.",
    },
  },
  activity: {
    title: "Активність",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Робоча область сеансу",
      expand: "Розгорнути робочу область сеансу",
      collapse: "Згорнути робочу область сеансу",
      workspace: "Сеанс",
      files: "Робоча область",
      refresh: "Оновити робочу область сеансу",
      loading: "Завантаження робочої області сеансу…",
      empty: "У цьому сеансі ще не змінено жодних файлів",
      changed: "Змінено",
      read: "Прочитано",
      artifacts: "Артефакти",
      browser: "Файли проєкту",
      path: "Шлях робочого простору",
      root: "Корінь",
      search: "Пошук файлів",
      ...
      session: "Сеанс",
      missing: "Відсутній",
      summary: "Підсумок робочого простору сеансу",
      changedCount: "{count} змінено",
      readCount: "{count} прочитано",
      artifactCount: "{count} артефактів",
