...
export const vi: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "Sử dụng cuộc trò chuyện hiện tại cho các yêu cầu sửa đổi",
      useCurrentChatTooltip:
        "Gửi yêu cầu sửa đổi đến phiên trò chuyện hiện tại thay vì phiên workshop của đề xuất.",
    },
  },
  activity: {
    title: "Hoạt động",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Không gian làm việc của phiên",
      expand: "Mở rộng không gian làm việc của phiên",
      collapse: "Thu gọn không gian làm việc của phiên",
      workspace: "Phiên",
      files: "Không gian làm việc",
      refresh: "Làm mới không gian làm việc của phiên",
      loading: "Đang tải không gian làm việc của phiên…",
      ...
      noBrowserFiles: "Không có tệp nào trong thư mục này.",
      ...
      browserCount: "{count} được hiển thị",
      actions: "Thao tác với tệp workspace",
      preview: "Xem trước",
