...
export const zh_CN: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatTooltip: "将修订请求发送到当前聊天会话，而不是提案的 workshop 会话。",
    },
  },
  activity: {
    title: "活动",
  ...
  workboard: {
    ...
    dependenciesBlocked: "{count} 个已阻塞",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      missing: "缺失",
      summary: "会话工作区摘要",
      changedCount: "{count} 项已更改",
      readCount: "已读 {count} 项",
      artifactCount: "{count} 个 Artifacts",
      browserCount: "已显示 {count} 项",
      actions: "工作区文件操作",
      preview: "预览",
      copyPath: "复制路径",
    },
