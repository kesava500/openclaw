...
export const zh_TW: TranslationMap = {
  ...
  skillWorkshop: {
    header: {
      ...
      useCurrentChatAria: "使用目前聊天進行修訂請求",
      useCurrentChatTooltip: "將修訂請求傳送至目前的聊天工作階段，而非提案的 workshop 工作階段。",
    },
  },
  activity: {
    title: "活動",
  ...
  workboard: {
    ...
    start: "開始",
    dependencies: "相依性",
    dependenciesReady: "{count} 個已就緒",
    dependenciesReadyTitle: "{count} 個相依性已完成。",
    dependenciesBlocked: "{count} 個受阻",
    dependenciesBlockedTitle: "正在等待相依性：{parents}。",
    dependencyMissing: "{parent}（遺失）",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      searchResults: "搜尋結果",
      parentFolder: "上層資料夾",
      noBrowserFiles: "此資料夾中沒有檔案。",
      noSearchResults: "沒有相符的檔案。",
      truncated: "顯示前幾個相符檔案。請調整搜尋以縮小結果範圍。",
      session: "工作階段",
      missing: "遺失",
      summary: "工作階段工作區摘要",
      changedCount: "{count} 已變更",
      readCount: "{count} 已讀取",
      artifactCount: "{count} 個 artifacts",
      browserCount: "{count} 個已顯示",
      actions: "工作區檔案操作",
      preview: "預覽",
      copyPath: "複製路徑",
    },
